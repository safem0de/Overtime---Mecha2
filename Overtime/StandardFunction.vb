...
Public Class StandardFunction
    ...
    Public Shared Sub fillDataTableToDataGrid(Target As GridView, SqlString As String, Optional insertStr As String = "")
    ...
    Public Shared Sub setDropdownlist(targetDropdownlist As DropDownList, txtQry As String, Optional addAll As String = Nothing)
        'Set parameter
        Dim con As New SqlClient.SqlConnection
        Dim command As SqlCommand
    ...
    Public Shared Sub getSheetExcel(targetPage As Page, targetFileUpload As FileUpload, targetDropdown As DropDownList)
        If (targetFileUpload.HasFile) Then
    ...
    Public Shared Function NewUploadXls(targetPage As Page, targetGridView As GridView, targetDropdown As DropDownList, DBName As String, DBTable As String) As DataTable
        Dim dt As DataTable = New DataTable
        ...
        Dim x = GetColumnHeader(DBTable, DBName)
    ...
    Public Shared Sub ExportExcelMultiSheet(TargetPage As Page, SqlString_Arr As ArrayList, fileName As String)
        ...
        For Each i In SqlString_Arr
            ds.Tables.Add(GetDataTable(i(0), i(1)))
        Next
